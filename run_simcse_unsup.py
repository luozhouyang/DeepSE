...
from transformers_keras import DatapipeForUnsupervisedSimCSE, SpearmanForSentenceEmbedding, UnsupervisedSimCSE

MODEL_DIR = "models/atec-unsup"
...
model = UnsupervisedSimCSE.from_pretrained(
...
# )
train_dataset = DatapipeForUnsupervisedSimCSE.from_jsonl_files(
...
valid_dataset = DatapipeForUnsupervisedSimCSE.from_jsonl_files(
...
model.fit(
    ...
    callbacks=[
        ...
        tf.keras.callbacks.ModelCheckpoint(
            filepath=os.path.join(os.path.join(MODEL_DIR, "unsup-simcse-{epoch:04d}.ckpt")), save_weights_only=True
        ),
